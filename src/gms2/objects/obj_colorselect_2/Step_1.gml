...
if (moving == 4)
{
    ...
    if (mouse_y-y < 47+9)
		...
		controller.color2 = make_color_rgb(0, 255, clamp(floor((mouse_x-x)/9)*63.75, 0, 255));
	else if (mouse_y-y < 47+27)
		controller.color2 = make_color_rgb(clamp(floor((mouse_x-x)/9)*63.75, 0, 255), 0, 255);
	else if (mouse_y-y < 47+36)
		controller.color2 = make_color_rgb(	255 - clamp(floor((mouse_x-x)/9)*63.75, 0, 255), 
