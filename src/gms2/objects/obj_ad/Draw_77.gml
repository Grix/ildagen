...
draw_set_colour(c_white);
    draw_rectangle(x,y-10*controller.dpi_multiplier,x+700*controller.dpi_multiplier,y+418*controller.dpi_multiplier,0);
draw_set_colour(c_dkgray);
    draw_rectangle(x,y+20*controller.dpi_multiplier,x+700*controller.dpi_multiplier,y+418*controller.dpi_multiplier,1);
...
draw_sprite_ext(ad, 0, x+1*controller.dpi_multiplier,y+20*controller.dpi_multiplier, controller.dpi_multiplier, controller.dpi_multiplier, 0, c_white, 1);
