/// @description ML_AddFunctionArgList(parser, functionstring,scriptid,returntype, argtypelist)
/// @function ML_AddFunctionArgList
/// @param parser
...
/// @returnType real
/// @hidden     false
function ML_AddFunctionArgList(argument0, argument1, argument2, argument3, argument4) {
	/*
	**  Usage:
