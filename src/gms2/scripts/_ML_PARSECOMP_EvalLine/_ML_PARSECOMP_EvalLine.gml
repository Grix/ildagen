/// @description _ML_PARSECOMP_EvalLine(parser, rpn, resultObject)
/// @function _ML_PARSECOMP_EvalLine
/// @param parser
/// @param  rpn
/// @param  resultObject
/// @argType    r,r,r
/// @returnType real
/// @hidden     true
function _ML_PARSECOMP_EvalLine(argument0, argument1, argument2) {
