/// @description _ML_SY_HandleRightPar(parser, token, output, stack, argcount, stackofoutputs, stackofstacks,  level);
/// @function _ML_SY_HandleRightPar
/// @param parser
/// @param  token
/// @param  output
/// @param  stack
/// @param  argcount
/// @param  stackofoutputs
/// @param  stackofstacks
/// @param   level
/// @argType    r,r,r,r,r,r,r,r
/// @returnType real
/// @hidden     true
function _ML_SY_HandleRightPar(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7) {
