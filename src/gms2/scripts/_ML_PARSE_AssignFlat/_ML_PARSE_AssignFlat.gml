/// @description _ML_PARSE_AssignFlat(parser, token, args, temptokens)
/// @function _ML_PARSE_AssignFlat
/// @param parser
/// @param  token
/// @param  args
/// @param  temptokens
...
/// @returnType void
/// @hidden     true
function _ML_PARSE_AssignFlat(argument0, argument1, argument2, argument3) {
