/// @description _ML_SY_HandleExprTerminator(parser, token, output, stack)
/// @function _ML_SY_HandleExprTerminator
/// @param parser
/// @param  token
/// @param  output
/// @param  stack
...
/// @returnType real
/// @hidden     true
function _ML_SY_HandleExprTerminator(argument0, argument1, argument2, argument3) {
