...
{
    dac_send_frame(t_dac, output_buffer, output_buffer_next_size, output_buffer_next_size*controller.projectfps);
...
if (!playing)
    ...
    correctframe = round(tlpos/1000*controller.projectfps)+1;
