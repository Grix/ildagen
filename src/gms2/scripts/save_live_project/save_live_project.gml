function save_live_project() {
	...
	file_loc = get_save_filename_ext("LSG Live Grids|*.igl","example"+string(current_hour) + "" + string(current_minute)+".igl","","Select LaserShowGen live grid file location");
