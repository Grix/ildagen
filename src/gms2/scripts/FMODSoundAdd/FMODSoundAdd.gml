/// @description export double FMODSoundAdd(LPCSTR soundfile, double threed, double streamed)
/// @function export double FMODSoundAdd
/// @param LPCSTR soundfile
/// @param  double threed
/// @param  double streamed
