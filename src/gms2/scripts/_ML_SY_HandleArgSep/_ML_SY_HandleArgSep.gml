/// @description _ML_SY_HandleArgSep(parser, token, output, stack);
/// @function _ML_SY_HandleArgSep
/// @param parser
/// @param  token
/// @param  output
/// @param  stack
...
/// @returnType real
/// @hidden     true
function _ML_SY_HandleArgSep(argument0, argument1, argument2, argument3) {
