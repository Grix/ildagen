/// @description _ML_SY_HandleOperator(parser, token, output, stack)
/// @function _ML_SY_HandleOperator
/// @param parser
/// @param  token
/// @param  output
/// @param  stack
...
/// @returnType real
/// @hidden     true
function _ML_SY_HandleOperator(argument0, argument1, argument2, argument3) {
