/// @description _ML_SY_HandleTernary2(parser, token, output, stack);
/// @function _ML_SY_HandleTernary2
/// @param parser
/// @param  token
/// @param  output
/// @param  stack
...
/// @returnType real
/// @hidden     true
function _ML_SY_HandleTernary2(argument0, argument1, argument2, argument3) {
