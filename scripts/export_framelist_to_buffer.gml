...
if (controller.exp_optimize)
{
    ...
    var t_lowersafezone = min(t_blankshift+3, t_redshift+3, t_greenshift+3, t_blueshift+3);
    var t_uppersafezone = max(t_blankshift+3, t_redshift+3, t_greenshift+3, t_blueshift+3);
}
var t_bl;
...
if (controller.exp_optimize)
{
    for (i = 0; i <= t_list_raw_size; i += 4)
    {
        ...
        if (i+t_uppersafezone > t_list_raw_size) or (i+t_lowersafezone < 0)
        {
            cr = 0;
            cg = 0;
            cb = 0;
