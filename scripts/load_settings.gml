ini_open("settings.ini");
    ...
    if (!ini_key_exists("main","projector"))
        ...
        ini_write_real("projector_0","maxdwell_blank",0);
        ...
        if (ini_section_exists(t_projectorstring))
            ...
            opt_maxdwell_blank = ini_read_real(t_projectorstring, "maxdwell_blank", 0);
            ...
            ini_write_real(t_projectorstring, "maxdwell_blank", 0);
