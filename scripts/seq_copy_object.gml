...
for (i = 0; i < ds_list_size(somaster_list); i++)
    ...
    ds_list_copy(copy_list_new,ds_list_find_value(ds_list_find_value(somaster_list,i),2)); 
    copy_buffer_new = buffer_create(1,buffer_grow,1);
    buffer_copy(ds_list_find_value(ds_list_find_value(somaster_list,i),1),
                0,
                buffer_get_size(ds_list_find_value(ds_list_find_value(somaster_list,i),1)),
                copy_buffer_new,
                0);
    ...
    if (i == 0)
        {
        selectedx = ds_list_find_value( ds_list_find_value(somaster_list,i),0)
                                        +ds_list_find_value(ds_list_find_value(ds_list_find_value(somaster_list,i),2),0)+1;
        }
    }
