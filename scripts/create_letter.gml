        ...
        if (blankmode == "dot")
            ...
            if (makedot == 2)
                ...
                if (blank)
                    ...
                    if (n)
                        {
                        ds_list_add(new_list,(ds_list_find_value(letter_list,20+6*(n-1))-$ffff/2)*font_size/64);
                        ds_list_add(new_list,(ds_list_find_value(letter_list,20+6*(n-1)+1)-$ffff/2)*font_size/64);
                        }
                    else
                        {
                        ds_list_add(new_list,(ds_list_find_value(letter_list,currentpos)-$ffff/2)*font_size/64);
